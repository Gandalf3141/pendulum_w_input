...
class CDEFunc(torch.nn.Module):
    def __init__(self, input_channels, hidden_channels):
        ...
        self.linear1 = torch.nn.Linear(hidden_channels, 28)
        self.linear2 = torch.nn.Linear(28, input_channels * hidden_channels)
...
def main(num_epochs=30):
    ...
    ######################
    model = NeuralCDE(input_channels=3, hidden_channels=5, output_channels=1)
